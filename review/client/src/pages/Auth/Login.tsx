  ...
  const handleSubmit = async (e) => {
    ...
    if (result.success) {
      ...
      if (result.user) {
        ...
        console.log("Role comparison result:", result.user.role === 'admin');
        
        // More flexible role checking - handle case variations and potential whitespace
        const userRole = result.user.role?.toString().toLowerCase().trim();
        ...
        // Fallback - navigate to intended page
        navigate(from, { replace: true });
      }
    } else {
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  onChange={handleChange}
                  className={`w-full px-3 py-2 pr-10 border rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent ${
